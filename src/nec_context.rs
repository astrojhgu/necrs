...
pub fn nec_error_message()->String{
    unsafe{ CStr::from_ptr(bindings::nec_error_message())}.to_string_lossy().to_owned().to_string()
}
...
impl NecContext{
    ...
    pub fn nec_wire(
        ...
        check_result(unsafe{bindings::nec_wire(self.ptr, tag_id, segment_count, xw1, yw1, zw1, xw2, yw2, zw2, rad, rdel, rrad)})
    }
    ...
    pub fn nec_gm_card(
        ...
        check_result(unsafe{bindings::nec_gm_card(self.ptr, itsi, nrpt, rox, roy, roz, xs, ys, zs, its)})
    }
    ...
    pub fn nec_geometry_complete(
        &mut self,
        gpflag: ::std::os::raw::c_int,
    ){
        check_result(unsafe{bindings::nec_geometry_complete(self.ptr, gpflag)})
    }

    pub fn nec_medium_parameters(
        &mut self,
        permittivity: f64,
        permeability: f64,
    ){
        check_result(unsafe{bindings::nec_medium_parameters(self.ptr, permittivity, permeability)})
    }
    ...
    pub fn nec_gn_card(
        ...
        check_result(unsafe{bindings::nec_gn_card(self.ptr, iperf, nradl, epse, sig, tmp3, tmp4, tmp5, tmp6)})
    }
    ...
    pub fn nec_fr_card(
        ...
        check_result(unsafe{bindings::nec_fr_card(self.ptr, in_ifrq, in_nfrq, in_freq_mhz, in_del_freq)})
    }
    ...
    pub fn nec_ld_card(
        ...
        check_result(unsafe{bindings::nec_ld_card(self.ptr, ldtyp, ldtag, ldtagf, ldtagt, tmp1, tmp2, tmp3)})
    }
    ...
    pub fn nec_ex_card(
        ...
        check_result(unsafe{bindings::nec_ex_card(self.ptr, extype, i2, i3, i4, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6)})
    }
    ...
    pub fn nec_excitation_voltage(
        ...
        check_result(unsafe{bindings::nec_excitation_voltage(self.ptr, tag, segment, v_real, v_imag)})
    }
    ...
    pub fn nec_excitation_current(
        ...
        check_result(unsafe{bindings::nec_excitation_current(self.ptr, x, y, z, a, beta, moment)})
    }
    ...
    pub fn nec_excitation_planewave(
        ...
        check_result(unsafe{bindings::nec_excitation_planewave(self.ptr, n_theta, n_phi, theta, phi, eta, dtheta, dphi, pol_ratio)})
    }
    ...
    pub fn nec_tl_card(
        ...
        check_result(unsafe{bindings::nec_tl_card(self.ptr, itmp1, itmp2, itmp3, itmp4, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6)})
    }
    ...
    pub fn nec_nt_card(
        ...
        check_result(unsafe{bindings::nec_nt_card(self.ptr, itmp1, itmp2, itmp3, itmp4, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6)})
    }
    ...
    pub fn nec_rp_card(
        ...
        check_result(unsafe{bindings::nec_rp_card(self.ptr, calc_mode, n_theta, n_phi, output_format, normalization, D, A, theta0, phi0, delta_theta, delta_phi, radial_distance, gain_norm)})
    }
    ...
    pub fn nec_ne_card(
        ...
        check_result(unsafe{bindings::nec_ne_card(self.ptr, itmp1, itmp2, itmp3, itmp4, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6)})
    }
    ...
    pub fn nec_nh_card(
        ...
        check_result(unsafe{bindings::nec_nh_card(self.ptr, itmp1, itmp2, itmp3, itmp4, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6)})
    }
    ...
    pub fn nec_pl_card(
        ...
        check_result(unsafe{bindings::nec_pl_card(self.ptr, outfile.as_ptr() as *const i8, itmp1, itmp2, itmp3, itmp4)})
    }
    ...
    pub fn nec_gain_rhcp_sd(&mut self, freq_index: ::std::os::raw::c_int)
        -> f64{
            unsafe{bindings::nec_gain_rhcp_sd(self.ptr, freq_index)}
    }

    pub fn nec_gain_lhcp_max(
        &mut self,
        freq_index: ::std::os::raw::c_int,
    ) -> f64{
    ...
    pub fn nec_gain_lhcp_sd(&mut self, freq_index: ::std::os::raw::c_int)
    -> f64{
        unsafe{bindings::nec_gain_lhcp_sd(self.ptr, freq_index)}
    }

    pub fn nec_impedance_real(
        &mut self,
        freq_index: ::std::os::raw::c_int,
    ) -> f64{
